...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  Principal: 'verified caller value is owned by packages/identity/principal/README.md',
  AgentPreset: 'discovered preset record is owned by packages/preset/agent-presets/README.md',
  PresetComposition: 'source-read rows and stamp record is owned by packages/preset/agent-presets/README.md',
