...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/bundle-source-node': { kind: 'none', reason: 'Locates and reads browser bundles for the client module system; registers nothing model-facing.' },
  ...
  'packages/host/webserver': { kind: 'none', reason: 'The web carrier dispatches browser requests to the routes other plugins register and registers nothing model-facing.' },
  'packages/host/webserver-node': { kind: 'none', reason: 'The Node listener behind the web carrier registers nothing model-facing.' },
